...
export function splitAndJoinRangoli(colorString, oldSep, newSep) {
  ...
  /*- .split(oldSep) se todo aur .join(newSep) se jodo
 *      - Separator change karna hai colors ke beech mein
 *      - Agar colorString string nahi hai, return ""
 *      - Example: splitAndJoinRangoli("red,blue,green", ",", " | ") 
 *      => "red | blue | green"*/
if( typeof colorString !="string"){
  return ""
}

    let string1 = colorString.split(oldSep).join(newSep)
    return string1
