 ...
 *      - Example: updatePrices({meetha:30, saada:20}, 10) => {meetha:40, saada:30}
 */
  if(typeof menu !=="object" || Array.isArray(menu)|| menu === null || !Number.isFinite(increase)){
        return {}
      }
 const updatedEntries = Object.entries(menu).map(([key,values])=>{
